package com.shianlife.shian_platform.custom.view.carousel;
...
import com.shianlife.shian_platform.adapter.CarouselAdapter;
import com.shianlife.shian_platform.custom.view.picrg.PicRadioGroup;
...
public class CarouselView extends LinearLayout implements PicRadioGroup.CallBack, ViewPager.OnPageChangeListener {
    ...
    public void setData(List<String> listUrl) {
        ...
        for (String url : listUrl) {
            ...
            AppUtils.loadPic(getContext(), iv, url, R.drawable.zhy_pic_loading);
            listIV.add(iv);
        }
